...
///fullWidth : 전체 1조각
///
///fiftyFifty : 각각 0.5씩 나누어진 2조각
///
///twoThirdsOneThird : horizontal - 2/3로 나누어진지고 vertical - 0.5로 나누어진 1조각
///
///oneThirdTwoThirds : horizontal - 1/3로 나누어진 2조각, vertical - 0.5로 나누어진 1조각
...
class MosaicGridFlowLayout: UICollectionViewLayout {
